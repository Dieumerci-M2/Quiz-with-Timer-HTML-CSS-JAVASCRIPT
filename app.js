...
let warningMessage = document.querySelector('.formlog .warning')
...
let listQuestion = document.querySelector('.text div')
let questionOne = document.querySelector('questionOne')
let questionTwo = document.querySelector('questionTwo')
let questionTree = document.querySelector('questionTree')
...
mainlog.addEventListener('click', ()=>{
...
mainoutput.addEventListener('click', ()=>{
